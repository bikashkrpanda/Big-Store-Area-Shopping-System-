 ...
 $name=$_POST['name'];
  ...
  $add=$_POST['add'];
   ...
   $contact=$_POST['contact'];
	...
	$res1=mysqli_query($db,"select * from user_details where email='$email'");

	$count=mysqli_num_rows($db,$res1);
...

	{
...

 	{
				 ...
				 $query="insert into user_details values('','$name','$email','$add','$contact','$password')";
...
<title>BIG STORE Shopping/new user</title>
...
<!--slider down data-->            
         ...
         <font style=" font-size:18px;"><b>Account Information</b></font>
            ...
            <form name="form1" method="post" class="form-group" onSubmit="return validate();">
            ...
            <tr><td>Name*</td><td><input class="form-control" type="text" name="name" style="width:300px; "></td></tr><br/><br/><br/>

            <tr><td>E-Mail Id*</td><td><input type="text" class="form-control" name="email" style="width:300px; "></td></tr>
            
             <tr><td>Address*</td><td><input type="text" class="form-control" name="add" style="width:300px; "></td></tr>

            

            <tr><td>Contact Number*</td><td><input type="text" class="form-control" name="contact" style="width:300px; "></td></tr>

          <tr style="background-color:#CDEFF3; color:#828282;height:30px;"><td colspan="2"><b>Password</b></td></tr>

            <tr><td>Password*</td><td><input type="password" class="form-control" name="pwd" style="width:300px; "></td></tr>

            <tr><td>Password Confirmation*</td><td><input class="form-control" type="password" name="cpwd" style="width:300px; "></td></tr>

           

            <tr><td colspan="2" align="right"><input type="submit" class="btn btn-primary" name="continue" value="Continue" style="border:1px solid #999999; border-radius:5px; height:35px; width:80px; font-size:16px; margin-right:25px;" align="middle"></td></tr>
