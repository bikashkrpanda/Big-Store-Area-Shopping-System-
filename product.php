...
session_start();
 $code=$_GET['code'];
//$r=mysql_query("select * from regis where pro_cat='$_REQUEST[pro_cat]'");
//$ff=mysql_fetch_assoc($r);
//echo $ff['pro_cat'];
...
<?php
		...
		if(!isset($_SESSION['email']) ||(!isset($_SESSION['pwd'])))
			...
			/*	echo "$email";
				...
				echo "$price";*/
				$queryadd="insert into shopping_cart values('','$email','$code','$pro_name','$image','$quantity','$price','','$pro_cat')";
				$rsadd=mysqli_query($db,$queryadd);
				if($rsadd)
				{
...
<!--slider down data-->
        ...
        <?php
          ...
          <!--product details--> <div style="height:auto; width:600px; border:0px solid #990000; float:left;" >
           ...
           <div style="height:30px; width:500px;border:0px solid #000000; color:#269FB2; margin-top:20px;" ><b><font size="+1"><?php echo $row['product_name'];?></font></b><span>(<?php echo $row['pro_cat']?>)</span></div>
