...
<div style="margin-left:-150px;"><?php include('left.php'); ?></div>

<!--right-->

<div style="width:400px; height:auto; float:left; margin-left:150px;box-shadow: 0 4px 8px 0 black, 0 6px 20px 0 rgba(0, 0, 0, 0.19); border:1px solid #999999; border-radius:10px; margin-top:5px; ">
...
<form name="form2" class="form-group" action="update1.php" method="post" style="margin:auto;" >
...
<?php   $qrys=mysqli_query($db,"select * from regis where remail='$_SESSION[textfield]' ");
  ...
  {
 ?>
                <td  style="width:20px; font-size:14px;">Your Shop: </td>
