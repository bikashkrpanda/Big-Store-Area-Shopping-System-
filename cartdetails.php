...
<title>BIG STORE Shopping/cartdetails</title>
...
<div style="width:100%; height:auto;">
   ...
   <!--header --><div style="height:120px; width:100%; background-color:;border:0px solid #000000;">
...
$_SESSION['amt']=$amt;
      ...
      <td width="300" style="background-color:#FFFFFF;"></td>
       ...
       <td  width="200" align="center"><?php echo" <font color='#FF0000'> <b>Rs. </b></font>" .$amt;?></td>
            ...
            <a href="products.php"><img src="images/bt_prced.png"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
