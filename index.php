...
<!--slider down data-->
            ...
            <div style="height:auto; width:1050px; margin:auto;   border:0px solid #000000; background-color: ">

            <!--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->        

                        <!--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  TV  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->  

                        <div style="height:50px; width:1050px; border:0px solid #000000; color:#452932; font-size:25px; background-color:#0099FF;border-radius:20px; margin-top:10px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); "><p style="margin-left:450px; margin-top:5px;"><b> HOT OFFERS</b></p></div>      
			 ...
			 $query="select * from product where pro_cat='Raj Electronics' limit 0,4";
		...
		?>
                   ...
                   <td  style=" width:255px; border:0px solid #0000CC;"align="center" >
                    ...
                    <div><table border="0" width="220">  <tr style="border:0px solid #000000; height:30px;" align="center"><td colspan="2"> <a href="product.php?code=<?php echo $row['product_code'];?>" style="text-decoration:none;">
...
?>
 ...
 <!--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->
            ...
            <!--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   MUSIC   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->        
			 ...
			 $query="select * from product where pro_cat='Sony Musics Care' limit 0,4";
            ...
            <!--%%%%%%%%%%%%%%%%%%%%%%%%%%%           CAMERAS              %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->        
			 ...
			 $query="select * from product where pro_cat='Bikash Cool Mobiles' limit 0,3";
...
<!--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->
            ...
            <!--%%%%%%%%%%%%%%%%%%%%%%%%%% % MOBILES  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->        
			 ...
			 $query="select * from product where pro_cat='kuldeep jwels' limit 0,3";
